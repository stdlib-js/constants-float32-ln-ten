...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/constants-float32-ln-ten/tags). For example,

```javascript
FLOAT32_LN10 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-ln-ten@v0.1.1-umd/browser.js' )
```
